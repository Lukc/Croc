...
Elm.Main.make = function (_elm) {
   ...
   _U.list([]),
   _U.list([A2($Html.h1,_U.list([]),_U.list([$Html.text("Prochain :")]))
           ,A2($Html.div,_U.list([$Html$Attributes.id("one")]),_U.list([]))
           ,A2($Html.h2,_U.list([]),_U.list([$Html.text("Suivant :")]))
           ,A2($Html.div,_U.list([$Html$Attributes.id("suite")]),_U.list([]))]));
